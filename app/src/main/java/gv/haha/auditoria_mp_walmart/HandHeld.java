...
public class HandHeld extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                IntentIntegrator integrator = new IntentIntegrator(HandHeld.this);
        ...
        fabDownloadData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new AlertDialog.Builder(HandHeld.this)
                        .setTitle("Seleccione...")
                        ...
                        .setNegativeButton("Información. " + etNumTienda.getText(), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (TextUtils.isEmpty(etNumTienda.getText())) {
                                    new classCustomToast(HandHeld.this).Show_ToastError("Favor selecionar pdv de la lista o ingrese código tienda");
                                } else {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(etNumTienda.getText())) {
                    if (!TextUtils.isEmpty(etSearch.getText())) {
                        ...
                        new classCustomToast(HandHeld.this).Show_ToastError("Por favor ingrese un valor a buscar.");
                    }
                } else {
                    new classCustomToast(HandHeld.this).Show_ToastError("Por favor ingrese un punto de venta de la lista.");
                }
            }
        });
            ...
            if (cursor.getCount() > 0) {
                ...
                for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
                    try {
                        ...
                        int color = Color.argb(255, rnd.nextInt(256) + 150, rnd.nextInt(256) + 150, rnd.nextInt(256) + 150);
        ...
        try {
            ...
            StringRequest jsonRequest = new StringRequest(Request.Method.POST,
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (success == 1) {
                                    ...
                                    Toast.makeText(HandHeld.this, message, Toast.LENGTH_LONG).show();
                                    llItems.removeAllViews();
                                }
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(HandHeld.this, "Error en la consulta al ws: ConsultarOnline " + error.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
    ...
    private void AgregarItem(String key, String value, int Color) {
        ...
        tvDato.setBackgroundColor(Color);
    ...
    class DescargarDataHandHeld extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(HandHeld.this);
            ...
            pDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                ...
                public void onCancel(DialogInterface dialog) {
                    ...
                    new AlertDialog.Builder(HandHeld.this).setMessage("Se ha cancelado la petición.").setIcon(R.drawable.ic_info).show();
                }
            });
            pDialog.show();
        ...
        protected void onPostExecute(JSONObject jsonObject) {
            ...
            try {
                ...
                if (jsonObject == null) {
                    new AlertDialog.Builder(HandHeld.this).setTitle("Error al Obtener.").setMessage("No se ha podido descargar, pueda que no tengas internet.").setIcon(R.drawable.ic_error).show();
                    pDialog.dismiss();
                } else {
                    int success = jsonObject.getInt("success");
                    String message = jsonObject.getString("message");
